  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Connect is developed by <span style="font-weight: 700;">Unknown Developers</span>  for learning purpose.</p>
        <p>The clone project includes chat , rechat , quote or even quote the quoted chat , like chat and nested comments.
          You can mention or add hashtag to yout Chat , change password or username.
        ...
        <p>By default you followed
          <a style="color:#207ce5;" href="ConnectOfficial">@ConnectOfficial</a> 
            to see their Chats.</p>
      </div>
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/assets/images/Logo.png"; ?>" alt="" height="30px" width="30px" />
            </div>
          </div>
      ...
      <div class="grid-posts">
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <input id="tweet-input" type="submit" name="chat" value="Chat" class="submit"
                            >
                          </div>
                      </div>
                      </form>
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search Connecter">
