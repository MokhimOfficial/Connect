...
<head>
    ...
    <title> <?php echo $profileData->name; ?> (@<?php echo $profileData->username; ?>) | Connect</title>
    <link rel="stylesheet" href="assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/css/all.min.css">
    <link rel="stylesheet" href="assets/css/profile_style.css?v=<?php echo time(); ?>">
  
    <link rel="shortcut icon" type="image/png" href="assets/images/Logo"> 
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/assets/images/Logo"; ?>" alt="" height="30px" width="30px" />
            </div>
          </div>
                 ...
                 <div   class="row position-fixed box-name">
                       ...
                       <div class="col-xs-10">
                           ...
                           <p class="home-tweets-num">
                              <?php echo Tweet::countTweets($profileData->id); ?> Chats</p>
                      </div>
                 </div>
